    ...
    <div className="page-section second" id="Bio">
      <div className="h-full flex flex-col justify-center items-center w-full px-40 ">
        ...
        <p className="text-brown text-xl mt-6">
          Demi Casha is a singer-songwriter from the Sunshine Coast, QLD, whose
          music tells stories about love, loss, healing, and the journey in
        ...
        <p className="text-brown text-xl mt-10">
          ...
          tambourine to bring dynamic energy to her set. She carefully crafts
          the rise and fall of each performance—moving between stripped-back
          stillness and raw, rhythmic foot-stompers. Her live shows are full of
          character and connection. What you see is what you get, and the banter
          between songs is as real and unfiltered as the music.
        </p>
        <p className="text-brown text-xl mt-10">
          ...
          River, and her work has been featured on Triple J Unearthed, 4ZZZ, and
          ABC Sunshine Coast.
        </p>
        <p className="text-brown text-xl mt-10">
          She recently released her most vulnerable single yet, The Journey
          (2025), and is currently in the process of recording a new album with
          producer JB Paterson at Easy Machine Records. It&apos;s shaping up to
          be a raw, emotionally honest body of work that captures Demi&apos;s
          growth, grit, and deepening connection to the artists and stories that
